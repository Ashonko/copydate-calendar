...
If you need a minified version, please replace this file with the main.min.js file from the GitHub repository. When replacing, rename the main.min.js file to main.js
*/
...
var CalendarView = class extends import_obsidian.ItemView {
  ...
  insertDateAtCursor(formattedDate) {
    ...
    const activeLeaf = workspace.getActiveViewOfType((_b = (_a = workspace.activeLeaf) == null ? void 0 : _a.view) == null ? void 0 : _b.constructor);
    ...
    if (markdownLeaves.length > 0) {
      ...
      const view = firstMarkdownLeaf.view;
      if (view && view.editor) {
...
var CopyDateSettingsTab = class extends import_obsidian2.PluginSettingTab {
  ...
  updatePreview(container) {
    ...
    const moment2 = window.moment || require_moment();
    let format = this.plugin.settings.dateFormat;
    if (format === "custom") {
      format = this.plugin.settings.customFormat;
    }
    try {
      const formattedDate = moment2(today).format(format);
